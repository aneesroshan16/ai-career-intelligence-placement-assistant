...
# an interpolation token. A DATABASE_URL with a URL-encoded special character
# in the password (e.g. "%40" for "@") will otherwise raise
# `configparser.InterpolationSyntaxError` here — escape it as "%%".
...
async def run_migrations_online() -> None:
    connectable = async_engine_from_config(
        ...
        connect_args={"prepared_statement_cache_size": 0, "statement_cache_size": 0} if "asyncpg" in database_url else {},
    )
